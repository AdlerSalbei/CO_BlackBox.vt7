class gm_westDeutschland {
    ...
    class Type {
        ...
        class Soldier_SL_F: Soldier_F {
            vest = __EVAL(PICK_BY_GM("gm_ge_army_vest_80_leader","rhsgref_chicom"));
            handgunWeapon = __EVAL(PICK_BY_GM("gm_p2a1_blk","hgun_Pistol_Signal_F"));
            handgunWeaponMagazine = __EVAL(PICK_BY_GM("gm_1Rnd_265mm_flare_single_wht_DM15","6Rnd_RedSignal_F"));
            binoculars = __EVAL(PICK_BY_GM("gm_ferod16_oli","Binocular"));
            radio = "";
            addItemsToVest[] = {
               LIST_5("gm_20Rnd_762x51mm_B_DM41_g3_blk"),
                LIST_1("SmokeShell")
