...
private _briefcase = missionNamespace getVariable ["grad_briefcase", objNull];
if (isNull _briefcase) exitWith {};

private _owner = _briefcase getVariable ["grad_briefcase_owner", objNull];
if (!isNull _owner) then {
    [_owner] call grad_briefcase_fnc_dropBriefcase;
};
